...
class Model_ComiRec_DR(Model):
    def __init__(self, n_mid, n_uid, embedding_dim, hidden_size, batch_size, num_interest, seq_len=256, hard_readout=True, relu_layer=False):
        super(Model_ComiRec_DR, self).__init__(n_mid, n_uid, embedding_dim, hidden_size, batch_size, seq_len, flag="ComiRec_DR")
